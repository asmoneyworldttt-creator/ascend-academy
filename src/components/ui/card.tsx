...
const cardVariants = cva(
  "rounded-lg border bg-card text-card-foreground shadow-sm transition-all duration-300 ease-out",
  {
    variants: {
      hover: {
        none: "",
        lift: "hover:-translate-y-2 hover:shadow-elevated cursor-pointer",
        scale: "hover:scale-[1.02] hover:shadow-lg cursor-pointer",
        glow: "hover:shadow-glow-gold hover:-translate-y-1 cursor-pointer",
        teal: "hover:shadow-glow-teal hover:-translate-y-1 cursor-pointer",
      },
    },
    defaultVariants: {
      hover: "none",
